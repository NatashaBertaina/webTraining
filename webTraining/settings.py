...
SECRET_KEY = 'django-insecure-fxb$%tmm620&@0-yh2^5zl6y_=8u92xij2wtla5gtd+mqhc3^e'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'static')#Define ruta

#Configuración de archivos de medios:
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')#Define ruta
