...
((SELECT id FROM trainingApp_block WHERE name_block = 'Funciones mas Ruido tipo 3'), 'Lo que usted escuchó fue una combinación de:', 'trainingApp/images/sin_imagen.png', 'trainingApp/sound/Cte-Decr-Cre_noise.mp3', 'What you heard was a combination of:', 'Lo que usted escuchó fue una combinación de:'),
...
((SELECT id FROM trainingApp_block WHERE name_block = 'Funciones mas Ruido tipo 3'), 'Lo que usted escuchó fue una combinación de:', 'trainingApp/images/sin_imagen.png', 'trainingApp/sound/Cre-Cte-Decr_noise.mp3', 'What you heard was a combination of:', 'Lo que usted escuchó fue una combinación de:'),
...
((SELECT id FROM trainingApp_block WHERE name_block = 'Funciones mas Ruido tipo 4'), 'Lo que usted escuchó fue una combinación de:', 'trainingApp/images/sin_imagen.png', 'trainingApp/sound/Coseno-Cre-Decr_noise.mp3', 'What you heard was a combination of:', 'Lo que usted escuchó fue una combinación de:'),
...
((SELECT id FROM trainingApp_block WHERE name_block = 'Funciones mas Ruido tipo 4'), 'Lo que usted escuchó fue una combinación de:', 'trainingApp/images/sin_imagen.png', 'trainingApp/sound/Cre-Seno-Cte_noise.mp3', 'What you heard was a combination of:', 'Lo que usted escuchó fue una combinación de:'),
...
((SELECT id FROM trainingApp_block WHERE name_block = 'Galaxias'), '¿Cuántos Picos identifica?', 'trainingApp/images/sin_imagen.png', 'trainingApp/sound/SDSS_J151806.13424445.0_1_sound.mp3', 'How many peaks do you identify?', '¿Cuántos Picos identifica?'),
((SELECT id FROM trainingApp_block WHERE name_block = 'Galaxias'), '¿Cuántos Picos identifica?', 'trainingApp/images/sin_imagen.png', 'trainingApp/sound/SDSS_J151806.13424445.0_3_sound.mp3', 'How many peaks do you identify?', '¿Cuántos Picos identifica?'),
...
((SELECT id FROM trainingApp_block WHERE name_block = 'Galaxias'), '¿Cuántos Picos y valles identifica?', 'trainingApp/images/sin_imagen.png', 'trainingApp/sound/SDSS_J115845.43-002715.7_4_sound.mp3', 'How many peaks and valleys do you identify?', '¿Cuántos Picos y valles identifica?'),
...
((SELECT id FROM trainingApp_block WHERE name_block = 'Estrellas y Galaxias' AND description LIKE '%absorción%'), '¿Lo que escuchó fue una estrella o una galaxia?', 'trainingApp/images/sin_imagen.png', 'trainingApp/sound/A5_ldIy8TB.mp3', 'What you heard was a star or a galaxy?', '¿Lo que escuchó fue una estrella o una galaxia?'),
...
((SELECT id FROM trainingApp_block WHERE name_block = 'Estrellas y Galaxias' AND description LIKE '%absorción%'), '¿Lo que escuchó fue una estrella o una galaxia?', 'trainingApp/images/sin_imagen.png', 'trainingApp/sound/SDSS_J115845.43-002715.7_3_sound.mp3', 'What you heard was a star or a galaxy?', '¿Lo que escuchó fue una estrella o una galaxia?'),
((SELECT id FROM trainingApp_block WHERE name_block = 'Estrellas y Galaxias' AND description LIKE '%absorción%'), '¿Lo que escuchó fue una estrella o una galaxia?', 'trainingApp/images/sin_imagen.png', 'trainingApp/sound/G0_wLxE5bO.mp3', 'What you heard was a star or a galaxy?', '¿Lo que escuchó fue una estrella o una galaxia?'),

((SELECT id FROM trainingApp_block WHERE name_block = 'Muones'), '¿Se captó un muon?', 'trainingApp/images/sin_imagen.png', 'trainingApp/sound/5762520_3538527_soundline.mp3', 'Was a muon captured?', '¿Se captó un muon?'),
((SELECT id FROM trainingApp_block WHERE name_block = 'Muones'), '¿Se captó un muon?', 'trainingApp/images/sin_imagen.png', 'trainingApp/sound/5793328_1297611_sound.mp3', 'Was a muon captured?', '¿Se captó un muon?'),
...
((SELECT id FROM trainingApp_block WHERE name_block = 'Muones'), '¿Se captó un muon?', 'trainingApp/images/sin_imagen.png', 'trainingApp/sound/5565547_19009797_soundline.mp3', 'Was a muon captured?', '¿Se captó un muon?'),
...
((SELECT id FROM trainingApp_block WHERE name_block = 'Muones'), '¿Se captó un muon?', 'trainingApp/images/sin_imagen.png', 'trainingApp/sound/5587922_22852548_sound.mp3', 'Was a muon captured?', '¿Se captó un muon?');
